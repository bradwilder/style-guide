...
final class StyleguideItemTypeTest extends TestCase
{
	private $db;
    ...
    {
		$new = new StyleguideItemType($this->db);
    ...
    {
		$new = new StyleguideItemType($this->db, 6);
	...
	public function testConstructorIDMatch()
    {
		...
		$this->assertEquals(1, $this->getTableCount());
		$new = new StyleguideItemType($this->db, $insertedID);
