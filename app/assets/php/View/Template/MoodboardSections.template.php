<?php foreach($data as $section) {
	...
	$pageSectionModel->content = MVCoutput(MoodboardSectionContentModel, MoodboardSectionContentController, SimpleView, 'MoodboardSectionContent.template.php', $currentUser, null, [$section]);
