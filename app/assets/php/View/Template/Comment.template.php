	...
	<div>
		<?php if ($hasPermission) { ?>
			<div class="comment__edit-button editable-section__button-container">
				<a tabindex="0" role="button" class="editable-section__button editable-section__button-edit editable-section__button--show comment__reply-button fa fa-reply"></a>
			</div>
		<?php } ?>
